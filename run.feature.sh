...
mkdir -p asrfeat vocab
python2 scripts/preprocess_asrfeat.py || exit 1;
python2 scripts/create_asrfeat.py $cluster_num || exit 1;

echo "Creating Mixed features"
mkdir -p mixed
python2 scripts/create_mixed.py || exit 1;
